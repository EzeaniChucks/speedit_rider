...
import { RootStackParamList, AuthStackParamList, AppStackParamList } from './nav.types';
...
const AuthNavigator = () => (
  ...
  >
    ...
    <AuthStack.Screen name="VerifyOtp" component={VerifyOtpScreen} options={{ title: 'Verify Code' }} />
   ...
   <AuthStack.Screen name="DocumentUploadScreen" component={DocumentUploadScreen} />
  <AuthStack.Screen name="VehicleSelectionScreen" component={VehicleIdUploadScreen} />
  <AuthStack.Screen name="LicenseCollectionScreen" component={LicenseCollectionScreen} />
  </AuthStack.Navigator>
);
  ...
  >
    ...
    <AppStack.Screen name="Profile" component={ProfileScreen} options={{ title: 'My Profile' }} />
     <AppStack.Screen name="OrderList" component={OrderListScreen} />
            <AppStack.Screen name="OrderPicked" component={OrderPicked} />
