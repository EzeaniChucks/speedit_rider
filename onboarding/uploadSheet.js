...
const UploadBottomSheet = ({ visible, onClose, onImageSelected }) => {
    ...
    const handleChooseFromLibrary = () => {
        chooseFromLibrary((imageData) => { // imageData is { uri, fileName, type } or null
            if (imageData) {
    ...
    return (
        <Animated.View style={[styles.container, { transform: [{ translateY }] }]}>
            <View style={styles.sheetContent}>
                ...
                <Box pt={6} pb={6} borderBottomColor={'gray.300'} borderTopColor={'gray.300'} borderBottomWidth={1} borderTopWidth={1}>
                ...
                <TouchableOpacity onPress={handleChooseFromLibrary} style={styles.button}>
