   ...
   <HStack space={4} justifyContent={'space-between'} marginBottom={10} >
      <VStack pl={2} width={'50%'} >
       ...
       <VStack width={'40%'}>
               ...
               <Text style={styles.fare}> N14</Text> </VStack>
      </HStack>
     ...
     <View style={styles.buttonContainer}>
              <Button title="Ignore" color="#ff4d4d" onPress={() =>setModalVisible(true)} />
              <Button title="Accept" color="teal" onPress={() => onAccept} />
            </View>
            <Modal
        transparent={true}
        animationType="slide"
...
//   }
  ...
  const handlePress = () => {
    navigation.navigate('PickupScreen',{order:offers});
  };
  return (
    <Box style={styles.container}>
      ...
      <FlatList
        data={offers}
        renderItem={({ item }) => <OrderCard offer={item} onAccept={()=>  navigation.navigate('PickupScreen')}  onPress={()=>handlePress()} />}
...
const styles = StyleSheet.create({
  container: {
    ...
    marginTop: 30,
    width:'98%',  left: 4,
   flex:1,paddingTop:11,paddingLeft:2,paddingBottom:20,justifyContent:'center'
  },
  header: {
 ...
 distance:  {
    fontSize: 20,  color: '#f4f4f4',fontWeight:'bold'
  ...
  fare: {
    ...
    flexDirection: 'row',
    justifyContent: 'space-between',
    marginTop: 20, borderTopColor: 'teal',borderTopWidth:1,paddingTop:10
  },
  offerImage: {
    width: '100%',
    height: 140,
  ...
  head: {
    ...
    fontFamily: 'Inter-SemiBold',
    color: 'rgba(51, 56, 63, 1)',
    paddingLeft: 15,paddingTop:10,letterSpacing:-1
  },
    buttonText: {
    fontFamily: 'Inter-Regular',
    fontSize: 14,
