...
import { Provider as PaperProvider, Card, Title, Button as PaperButton } from 'react-native-paper'; // Ensure this is Paper's Button
...
console.log("Balance:", balance, "Status:", balanceStatus, "Error:", balanceError);
  ...
  return (
    <PaperProvider> {/* If you are using Paper components */}
          ...
          <Card.Content style={{alignItems:'center',alignContent:'center'}}>
            <HStack space={3} style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              ...
              <VStack space={4} alignItems={'flex-start'}>
                ...
                <Box style={styles.boxContainer}>
                  <Text style={styles.deliveryText}>Online Delivery (Sample)</Text>
...
const styles = StyleSheet.create({
  ...
  boxContainer: {
    ...
    elevation: 3, width:170 // Might need to adjust width based on screen
  },
  card: { marginTop:20, padding: 0, marginBottom: 20, backgroundColor: '#f8f8f8' }, // Reduced card padding
  ...
  button: { justifyContent: 'center',alignItems:'center', backgroundColor:'teal', borderRadius: 10, marginTop: 10 },
});
